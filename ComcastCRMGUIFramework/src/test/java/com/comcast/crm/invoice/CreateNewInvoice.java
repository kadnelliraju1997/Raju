package com.comcast.crm.invoice;
...
import com.comcast.crm.objectrepository.invoicepage.CreateNewInvoicePage;
import com.comcast.crm.objectrepository.invoicepage.InvoiceInformationPage;
...
public class CreateNewInvoice extends BaseClass {
	...
	public void createInvoice() throws Throwable {
		...
		CreateNewInvoicePage cinp = new CreateNewInvoicePage(driver);
		...
		// create invoice
		cinp.createInvoice(hp, cinp, campaignName, lp, driver, orgName, lastName, productName, productQty);
		
		// verify the Invoice
		iip.verifySubject(subject);
