...
public class CreateNewAssetsPage {
	...
	public void createAsset(HomePage hp, CreateAssetsPage cap, String serialNumber, String assetName,
			WebDriverUtility wlib, String productName, String orgName, WebDriver driver) {
